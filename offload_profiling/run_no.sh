...
NSYS_OUTPUT_PREFIX="${NSYS_OUTPUT_PREFIX:-$PROFILES_DIR/no_offload_nsys}"
VIDEO_OUT="${VIDEO_OUT:-$RESULTS_DIR/nsys_no_offload_profiled.mp4}"
PERF_OUT="${PERF_OUT:-$PROFILES_DIR/perf_no_offload_profiled.json}"
