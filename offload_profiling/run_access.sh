...
export SGLANG_DIT_PHASE_AWARE_PREFETCH="${SGLANG_DIT_PHASE_AWARE_PREFETCH:-0}"
export SGLANG_DIT_COMM_AWARE_PATCH_TORCH_DIST="${SGLANG_DIT_COMM_AWARE_PATCH_TORCH_DIST:-0}"
export SGLANG_DIT_COMM_ACTIVE_WINDOW_MODE="${SGLANG_DIT_COMM_ACTIVE_WINDOW_MODE:-kernel}"
...
echo "SGLANG_DIT_COMM_ACTIVE_WINDOW_MODE=${SGLANG_DIT_COMM_ACTIVE_WINDOW_MODE}"
